      ...
      <Card className="shadow-lg border-0 bg-white/90 backdrop-blur-sm">
        <CardContent className="p-6">
          <div className="flex items-center justify-center space-x-2">
            ...
            <span className="text-slate-600">Loading company status...</span>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <CardHeader className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-t-lg">
        <CardTitle className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-slate-900">Training Status</span>
          </div>
          <Button
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <p className="font-semibold text-slate-900">Company ID: {company.name}</p>
                <p className="text-sm text-slate-600">Model Training Status</p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-lg p-4 border border-slate-200">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-sm font-medium text-slate-700">Real-time Status</span>
            </div>
